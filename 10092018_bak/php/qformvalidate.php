...
$ip = isset($_SERVER['HTTP_CLIENT_IP'])?$_SERVER['HTTP_CLIENT_IP']:isset($_SERVER['HTTP_X_FORWARDED_FOR'])?$_SERVER['HTTP_X_FORWARDED_FOR']:$_SERVER['REMOTE_ADDR'];
extract($_POST);
$sql = "INSERT into tes_quote_form
(first_name,last_name,email,phone_no,website_url,budget_select,contact_select,comment,date,ipaddress) VALUES
('" . $fname . "','" . $lname . "','" . $email . "','" . $pno . "','" . $url . "','" . $budget . "','" . $preference . "','" . $query . "','" . date('Y-m-d') . "','" . $ip . "')";
